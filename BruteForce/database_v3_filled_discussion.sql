...
START TRANSACTION;
USE `scheduling`;
INSERT INTO `scheduling`.`Discussion_Sections` (`sectionID`, `type`, `start_time`, `end_time`, `day`, `instructor`, `numRegistered`, `classCapacity`, `Building_ID`, `Course_ID`, `Lecture_SectionID`) VALUES ('3000', 'Discussion', '15:00', '16:50', 'Friday', NULL, 0, 100, 'VKC', 3, '2');
INSERT INTO `scheduling`.`Discussion_Sections` (`sectionID`, `type`, `start_time`, `end_time`, `day`, `instructor`, `numRegistered`, `classCapacity`, `Building_ID`, `Course_ID`, `Lecture_SectionID`) VALUES ('3001', 'Discussion', '15:00', '16:50', 'Friday', NULL, 0, 100, 'VKC', 3, '5');
INSERT INTO `scheduling`.`Discussion_Sections` (`sectionID`, `type`, `start_time`, `end_time`, `day`, `instructor`, `numRegistered`, `classCapacity`, `Building_ID`, `Course_ID`, `Lecture_SectionID`) VALUES ('3002', 'Discussion', '15:00', '16:50', 'Friday', NULL, 0, 100, 'VKC', 3, '8');
