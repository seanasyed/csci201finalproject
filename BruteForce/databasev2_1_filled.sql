...
START TRANSACTION;
USE `scheduling`;
INSERT INTO `scheduling`.`Section` (`sectionID`, `type`, `start_time`, `end_time`, `am_pm`, `day`, `instructor`, `numRegistered`, `classCapacity`, `Building_ID`, `Course_ID`) VALUES ('29908D', 'Lecture', '9:00', '9:50', 'am', 'Mon, Wed', 'Mark Redekopp', 0, 50, 'GFS', 1);
INSERT INTO `scheduling`.`Section` (`sectionID`, `type`, `start_time`, `end_time`, `am_pm`, `day`, `instructor`, `numRegistered`, `classCapacity`, `Building_ID`, `Course_ID`) VALUES ('30225R', 'Lab', '4:30', '5:20', 'pm', 'Tuesday', NULL, 0, 15, 'VKC', 1);
...
START TRANSACTION;
USE `scheduling`;
INSERT INTO `scheduling`.`SectionDependencies` (`sectionID`, `linkedLab`, `linkedDisscussion`, `linkedQuiz`) VALUES ('29908D', '30225R', NULL, NULL);
